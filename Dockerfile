...
RUN apt-get update && apt-get -y upgrade && apt-get -y install nginx nodejs \
...
RUN npm install --global yarn && php -r "copy('https://getcomposer.org/installer', 'composer-setup.php');" \
